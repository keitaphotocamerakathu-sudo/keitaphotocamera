...
function setTrimControlsEnabled(enabled) {
  for (const el of [els.trimEnabled, els.startRange, els.endRange, els.setStartBtn, els.setEndBtn, els.jumpStartBtn, els.jumpEndBtn, els.clearTrimBtn, els.previewSelectionBtn]) {
    el.disabled = !enabled || state.processing;
  }
}
